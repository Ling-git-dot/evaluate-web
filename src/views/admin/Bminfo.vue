...
export default {
  ...
  methods: {
    ...
    save() {
      if (this.formData.id != null) {
        ...
        this.$refs["formDataRef"].validate((valid) => {
          if (valid) {
            let url = base + "/bminfo/update?id=" + this.formData.id;
    ...
    handleDelete(index, row) {
      this.$confirm("确认删除该记录吗?", "提示", {
        ...
        .then(() => {
          ...
          let url = base + "/bminfo/del?id=" + row.id;
    ...
    getDatas() {
      ...
      this.listLoading = true;
      let url = base + "/bminfo/list?currentPage=" + this.page.currentPage;
      console.log(url);
